...
//  @ACCESS     USER or ADMIN
    ...
    @RequestMapping(value = "/user/{userId}/reservation/{reservationId}/completed", method = RequestMethod.POST)
...
//  @ACCESS     USER or ADMIN
    @RequestMapping(value = "/user/{userId}/reservation/{reservationId}/cancelled", method = RequestMethod.DELETE)
