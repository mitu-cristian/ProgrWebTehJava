...
public class ReviewService {
    ...
    public List<ReviewResponse> getAllReviews() {
        ...
        List<ReviewResponse> listReviewsResponse = new ArrayList<>();
        listReviews.forEach(
                listReview -> {
                    listReviewsResponse.add(
                      new ReviewResponse.Builder()
                              .firstname(listReview.getUser().getFirstname())
                              .lastname(listReview.getUser().getLastname())
                              .rating(listReview.getRating())
                              .description(listReview.getDescription())
                              .build()
                    );
                }
        );
